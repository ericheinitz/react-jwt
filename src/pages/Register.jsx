...
export default function Register() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-slate-300/75 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')]bg-slate-300/75 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')]">

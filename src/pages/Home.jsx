    ...
    return (
        <AuthenticatedLayout user={user}>
            <div className="sm:py-12">
                <article className="max-w-7xl mx-auto bg-white px-2 sm:px-8 pt-8 rounded shadow-lg">
                    ...
                    <p className="mt-4 text-lg text-center text-slate-700">
                        ...
                        (usando cookies HTTP only) y gestionando datos con <strong>PostgreSQL</strong>.
                    </p>
